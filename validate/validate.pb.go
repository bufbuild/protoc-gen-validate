...
// source: github.com/lyft/protoc-gen-validate/validate/validate.proto

/*
Package validate is a generated protocol buffer package.

It is generated from these files:
	github.com/lyft/protoc-gen-validate/validate/validate.proto
...
type isFieldRules_Type interface{ isFieldRules_Type() }
...
type StringRules struct {
	...
	// In specifies that this field must be equal to one of the specified
	// values
	In []string `protobuf:"bytes,12,rep,name=in" json:"in,omitempty"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []string `protobuf:"bytes,13,rep,name=not_in,json=notIn" json:"not_in,omitempty"`
...
type isStringRules_WellKnown interface{ isStringRules_WellKnown() }

type StringRules_Email struct {
	Email bool `protobuf:"varint,14,opt,name=email,oneof"`
}
type StringRules_Hostname struct {
	Hostname bool `protobuf:"varint,15,opt,name=hostname,oneof"`
}
type StringRules_Ip struct {
	Ip bool `protobuf:"varint,16,opt,name=ip,oneof"`
}
type StringRules_Ipv4 struct {
	Ipv4 bool `protobuf:"varint,17,opt,name=ipv4,oneof"`
}
type StringRules_Ipv6 struct {
	Ipv6 bool `protobuf:"varint,18,opt,name=ipv6,oneof"`
}
type StringRules_Uri struct {
	Uri bool `protobuf:"varint,19,opt,name=uri,oneof"`
}
type StringRules_UriRef struct {
	UriRef bool `protobuf:"varint,20,opt,name=uri_ref,json=uriRef,oneof"`
}
...
type isBytesRules_WellKnown interface{ isBytesRules_WellKnown() }
...
var E_Disabled = &proto.ExtensionDesc{
	...
	Filename:      "github.com/lyft/protoc-gen-validate/validate/validate.proto",
}
...
func init() {
	proto.RegisterFile("github.com/lyft/protoc-gen-validate/validate/validate.proto", fileDescriptor0)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
