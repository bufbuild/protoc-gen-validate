...
func (x *StringRules) GetJson() bool {
	if x, ok := x.GetWellKnown().(*StringRules_Json); ok {
		return x.Json
	}
	return false
}
...
type StringRules_Json struct {
	// json 验证字符串是否为有效的 JSON 格式
	Json bool `protobuf:"varint,28,opt,name=json,oneof"`
}
...
func (*StringRules_Json) isStringRules_WellKnown() {}
...
var file_validate_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x22, 0xea,
	...
	0x6e, 0x52, 0x65, 0x67, 0x65, 0x78, 0x12, 0x14, 0x0a, 0x04, 0x6a, 0x73, 0x6f, 0x6e, 0x18, 0x1c,
	0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x04, 0x6a, 0x73, 0x6f, 0x6e, 0x12, 0x1c, 0x0a, 0x06,
	...
	0x6c, 0x65, 0x73, 0x52, 0x05, 0x72, 0x75, 0x6c, 0x65, 0x73, 0x42, 0x50, 0x0a, 0x1a, 0x69, 0x6f,
