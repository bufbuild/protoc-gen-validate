...
func (x *StringRules) GetCidr() bool {
	if x, ok := x.GetWellKnown().(*StringRules_Cidr); ok {
		return x.Cidr
	}
	return false
}
...
type StringRules_Cidr struct {
	// CIDR specifies that the field must be a network address in valid CIDR
	// notation as defined in RFC 4623 and RFC 4291.
	Cidr bool `protobuf:"varint,27,opt,name=cidr,oneof"`
}
...
func (*StringRules_Cidr) isStringRules_WellKnown() {}
...
var file_validate_validate_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x22, 0xea, 0x05, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x69,
	...
	0x14, 0x0a, 0x04, 0x63, 0x69, 0x64, 0x72, 0x18, 0x1b, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52,
	0x04, 0x63, 0x69, 0x64, 0x72, 0x12, 0x1c, 0x0a, 0x06, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x18,
