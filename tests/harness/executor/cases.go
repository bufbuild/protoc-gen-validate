...
var repeatedCases = []TestCase{
	...
	{"repeated - items - invalid (in)", &cases.RepeatedItemPattern{Val: []string{"baz"}}, false},
	{"repeated - items - valid (in)", &cases.RepeatedItemPattern{Val: []string{"foo"}}, false},
	{"repeated - items - invalid (not_in)", &cases.RepeatedItemPattern{Val: []string{"foo"}}, false},
	{"repeated - items - valid (not_in)", &cases.RepeatedItemPattern{Val: []string{"baz"}}, false},
