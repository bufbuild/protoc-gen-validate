...
var mapCases = []TestCase{
	...
	{"map - keys - valid (in)", &cases.MapKeysIn{Val: map[string]string{"test": "a"}}, true},
	{"map - keys - valid (not_in)", &cases.MapKeysNotIn{Val: map[string]string{"not_test": "a"}}, true},
  {"map - keys - invalid (int32)", &cases.MapKeys{Val: map[int32]string{1: "a"}}, false},
  {"map - keys - invalid (int64)", &cases.MapKeys{Val: map[int64]string{1: "a"}}, false},
	{"map - keys - invalid (pattern)", &cases.MapKeysPattern{Val: map[string]string{"A": "a", "!@#$%^&*()": "b"}}, false},
	{"map - keys - invalid (in)", &cases.MapKeysIn{Val: map[string]string{"A": "a"}}, false},
	{"map - keys - invalid (not_in)", &cases.MapKeysNotIn{Val: map[string]string{"test": "a"}}, false},
	...
	{"map - values - valid (in)", &cases.MapValuesIn{Val: map[string]string{"a": "test"}}, true},
	{"map - values - valid (not_in)", &cases.MapValuesNotIn{Val: map[string]string{"a": "A"}}, true},
	...
	{"map - values - invalid (in)", &cases.MapValuesIn{Val: map[string]string{"a": "A"}}, false},
	{"map - values - invalid (not_in)", &cases.MapValuesNotIn{Val: map[string]string{"a": "test"}}, false},
