...
var stringCases = []TestCase{
	...
	{"string - pattern (i18n) - valid", &cases.StringPatternI18N{Val: "हैलो, मैं बत्तीस साल का हूँ. दुःख"}, true, ""},
	{"string - pattern (i18n) - invalid", &cases.StringPatternI18N{Val: "।॥"}, false, "invalid StringPatternI18N.Val: value does not match regex pattern \"[\\pL\\pM\\pN][\\pL\\pM\\pN .,'’&+_\\-/\\|\\(\\)\\[\\]]\""},

	{"string - pattern (custom parameterized error message)", &cases.StringPatternErrParam{Val: "a\000"}, false, "invalid StringPatternErrParam.Val: value must match this regex: \"(?i)^[\\pL\\pM\\pN]+$\""},
	{"string - pattern (custom non-parameterized error message)", &cases.StringPatternErrOverride{Val: "a\000"}, false, "invalid StringPatternErrOverride.Val: allowed special characters: .,'&+_-/|()[]"},
