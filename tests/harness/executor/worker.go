...
func Work(wg *sync.WaitGroup, in <-chan TestCase, out chan<- TestResult, goFlag, ccFlag, javaFlag, pythonFlag bool) {
	for tc := range in {
...
func execTestCase(tc TestCase, goFlag, ccFlag, javaFlag, pythonFlag bool) (ok, skip bool) {
