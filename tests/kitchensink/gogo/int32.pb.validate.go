...
func (m *Int32) Validate() error {
	...
	if _, ok := _Int32_In_InLookup[m.GetIn()]; !ok {
		return Int32ValidationError{
			Field:  "In",
	...
	if _, ok := _Int32_NotIn_NotInLookup[m.GetNotIn()]; ok {
		return Int32ValidationError{
			Field:  "NotIn",
...
var _Int32_In_InLookup = map[int32]struct{}{
	30: {},
	35: {},
}

var _Int32_NotIn_NotInLookup = map[int32]struct{}{
	40: {},
	45: {},
}
