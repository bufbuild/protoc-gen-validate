...
// Validate checks the field values on UInt64 with the rules defined in the
// proto definition for this message. If any rules are violated, an error is returned.
func (m *UInt64) Validate() error {
	if m == nil {
		return nil
	}
	...
	if _, ok := _UInt64_In_InLookup[m.GetIn()]; !ok {
		return UInt64ValidationError{
			Field:  "In",
	...
	if _, ok := _UInt64_NotIn_NotInLookup[m.GetNotIn()]; ok {
		return UInt64ValidationError{
			Field:  "NotIn",
...
// UInt64ValidationError is the validation error returned by UInt64.Validate if
// the designated constraints aren't met.
type UInt64ValidationError struct {
	Field  string
	Reason string
	Cause  error
	Key    bool
...
func (e UInt64ValidationError) Error() string {
	cause := ""
	if e.Cause != nil {
...
var _ error = UInt64ValidationError{}

var _UInt64_In_InLookup = map[uint64]struct{}{
	30: {},
	35: {},
}

var _UInt64_NotIn_NotInLookup = map[uint64]struct{}{
	40: {},
	45: {},
}
