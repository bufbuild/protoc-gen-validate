...
// Validate checks the field values on Fixed64 with the rules defined in the
// proto definition for this message. If any rules are violated, an error is returned.
func (m *Fixed64) Validate() error {
	if m == nil {
		return nil
	}
	...
	if _, ok := _Fixed64_In_InLookup[m.GetIn()]; !ok {
		return Fixed64ValidationError{
			Field:  "In",
	...
	if _, ok := _Fixed64_NotIn_NotInLookup[m.GetNotIn()]; ok {
		return Fixed64ValidationError{
			Field:  "NotIn",
...
// Fixed64ValidationError is the validation error returned by Fixed64.Validate
// if the designated constraints aren't met.
type Fixed64ValidationError struct {
	Field  string
	Reason string
	Cause  error
	Key    bool
...
func (e Fixed64ValidationError) Error() string {
	cause := ""
	if e.Cause != nil {
...
var _ error = Fixed64ValidationError{}

var _Fixed64_In_InLookup = map[uint64]struct{}{
	30: {},
	35: {},
}

var _Fixed64_NotIn_NotInLookup = map[uint64]struct{}{
	40: {},
	45: {},
}
