...
// Validate checks the field values on SFixed64 with the rules defined in the
// proto definition for this message. If any rules are violated, an error is returned.
func (m *SFixed64) Validate() error {
	if m == nil {
		return nil
	}
	...
	if m.GetLt() >= 5 {
		return SFixed64ValidationError{
			Field:  "Lt",
	...
	if _, ok := _SFixed64_In_InLookup[m.GetIn()]; !ok {
		return SFixed64ValidationError{
			Field:  "In",
	...
	if _, ok := _SFixed64_NotIn_NotInLookup[m.GetNotIn()]; ok {
		return SFixed64ValidationError{
			Field:  "NotIn",
...
// SFixed64ValidationError is the validation error returned by
// SFixed64.Validate if the designated constraints aren't met.
type SFixed64ValidationError struct {
	Field  string
	Reason string
	Cause  error
	Key    bool
...
func (e SFixed64ValidationError) Error() string {
	cause := ""
	if e.Cause != nil {
...
var _ error = SFixed64ValidationError{}

var _SFixed64_In_InLookup = map[int64]struct{}{
	30: {},
	35: {},
}

var _SFixed64_NotIn_NotInLookup = map[int64]struct{}{
	40: {},
	45: {},
}
