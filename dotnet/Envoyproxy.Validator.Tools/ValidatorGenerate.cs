...
namespace Envoyproxy.Validator
{
    ...
    /// </summary>
    public class ValidatorGenerate : ToolTask
    {
        /*
        ...
        */
        ...
        /// <summary>
        /// Full path to the validate plugin executable.
        /// Switch: --plugin=protoc-gen-validate=
        /// </summary>
        [Required]
        public string ValidatePluginExe { get; set; }
        ...
        protected override string GenerateResponseFileCommands()
        {
            ...
            cmd.AddSwitchMaybe("validate_out", TrimEndSlash(OutputDir));
            cmd.AddSwitchMaybe("validate_opt", "lang=dotnet");
            cmd.AddSwitchMaybe("plugin=protoc-gen-validate", ValidatePluginExe);
            if (ProtoPath != null)
            {
