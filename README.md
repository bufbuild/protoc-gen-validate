...
```python
from protoc_gen_validate.validator import validate, FailedValidation

p = Person()
validate(p) # This should either return None or raise a ValidationFailed exception.
```

You can view what code has been generated like this:
```python
from protoc_gen_validate.validator import validate, print_validate, FailedValidation

p = Person()
validate(p)
printer = print_validate()
```
