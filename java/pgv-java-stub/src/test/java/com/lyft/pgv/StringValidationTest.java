...
public class StringValidationTest {
    ...
    public void inWorks() throws ValidationException {
        ...
        // In
        StringValidation.in("x", "foo", set);
        // Not In
        assertThatThrownBy(() -> StringValidation.in("x", "baz", set)).isInstanceOf(ValidationException.class);
    }
    ...
    public void notInWorks() throws ValidationException {
        String[] set = new String[]{"foo", "bar"};
        // In
        assertThatThrownBy(() -> StringValidation.notIn("x", "foo", set)).isInstanceOf(ValidationException.class);
        // Not In
        StringValidation.notIn("x", "baz", set);
    }
